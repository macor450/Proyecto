...
$Usuarrio = $sentencia->fetchAll(PDO::FETCH_OBJ);
              ...
              <table class="table align-middle">
                ...
                foreach($Usuarrio as $dato){
                  ...
                  <tr>
                    ...
                    <td ><a class="text-success" href="editar.php?idUsuario=<?php echo $dato->idUsuario; ?>"><i class="bi bi-pencil"></i></a></td>
                    <td  ><a class="text-danger" href="eliminar.php?idUsuario=<?php echo $dato->idUsuario; ?>"><i class="bi bi-trash3"></i></a></td>
      ...
      <div class="card">
        ...
        <form class="p-4" method="POST" action="registrar.php">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="txtClave"autofocous required>
          </div>
          <div class="mb-3">
