...
$Proveeor = $sentencia->fetchAll(PDO::FETCH_OBJ);
          ...
          <div class="p-2">
            <div class="table-responsive">
              <table class="table align-middle">
                ...
                <?php
                foreach($Proveeor as $dato){
                  ?>
                  <tr>
                    <td scope="row"><?php echo $dato->idProveedor; ?></td>
                    <td><?php echo $dato->Nombre; ?></td>
                    <td><?php echo $dato->Email; ?></td>
                    <td><?php echo $dato->Codigo; ?></td>
                    <td ><a class="text-success" href="editar.php?idProveedor=<?php echo $dato->idProveedor; ?>"><i class="bi bi-pencil"></i></a></td>
                    <td  ><a class="text-danger" href="eliminar.php?idProveedor=<?php echo $dato->idProveedor; ?>"><i class="bi bi-trash3"></i></a></td>
