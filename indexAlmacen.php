            ...
            <div class="table-responsive">
              <table class="table align-middle">
                ...
                foreach($Almacen as $dato){
                  ?>
                  <tr>
                    <td scope="row"><?php echo $dato->idAlmacen; ?></td>
                    <td><?php echo $dato->Nombre; ?></td>
                    <td><?php echo $dato->Matricula; ?></td>
                    <td ><a class="text-success" href="editar.php?idAlmacen=<?php echo $dato->idAlmacen; ?>"><i class="bi bi-pencil"></i></a></td>
                    <td  ><a class="text-danger" href="eliminar.php?idAlmacen=<?php echo $dato->idAlmacen; ?>"><i class="bi bi-trash3"></i></a></td>
